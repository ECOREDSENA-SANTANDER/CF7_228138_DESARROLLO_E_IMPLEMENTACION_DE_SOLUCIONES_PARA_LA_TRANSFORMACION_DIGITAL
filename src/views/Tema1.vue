        ...
        .tarjeta.color-acento-botones-2.p-4
          .row.align-items-center.justify-content-center
            .col-12.my-3.mt-5
              ...
              p Esta tecnología se basa en el uso de la inteligencia artificial, permitiendo a los líderes de la organización recibir recomendaciones técnicas sobre problemas específicos y complejos, simula procesos sobre los cuales se va acumulando conocimiento para predicciones cada vez más confiables.
    ...
    .row.align-items-center.justify-content-center.mb-4(data-aos="zoom-in-left")
      .col-lg-4.mb-2-cus
        .bg11.d-flex.px-3.he-1-cus
          ...
          p.ml-1-custom.mt-2.wd-80-cus Transformación sociocultural en la forma de relacionamiento y comunicación.
      .col-lg-4.mb-2-cus
        .bg11.d-flex.px-3.he-1-cus
