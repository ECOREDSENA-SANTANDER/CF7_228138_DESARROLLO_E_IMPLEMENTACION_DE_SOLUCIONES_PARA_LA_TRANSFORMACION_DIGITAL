...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-12
        .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mb-5
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Para el diseño del plan de gestión de servicios de <b>TI</b>, es importante tener en cuenta las actividades descritas en la G.ST.01 Guía del dominio de servicios tecnológicos, del Ministerio de Tecnologías de la Información y las Comunicaciones, del 2014, documento que permite la adopción de los elementos del dominio de los servicios tecnológicos, para Colombia, en el marco de la arquitectura de TI, razón por la cual se tomará de manera literal para su comprensión e implementación.

    p(data-aos="fade-down").mb-5.fw-bold Las tecnologías de la información, se pueden clasificar de la siguiente manera:  

    SlyderA(tipo="b").slider-a-custom
    ...
    #t_1_1.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
      h2 1.1  Características y tipos
    .row.align-items-center.justify-content-center.mb-4
      .col-lg-7.my-3
        p(data-aos="fade-down") Las tecnologías de la información van evolucionando con el tiempo, de acuerdo con las necesidades sociales, gubernamentales, empresariales o de negocio, permitiendo lo que hoy conocemos como desarrollo tecnológico, que trae consigo la creación de nuevas tecnologías y que han permitido transformaciones y cambios en la cultura, la comunicación.
        .bg10.p-4.mb-1(data-aos="fade-left") Las características de las TI estimulan la interactividad entre usuarios y la transmisión de información por medio de dispositivos, se adaptan según las necesidades de las personas y del mercado, se ejecutan a gran velocidad gracias al internet y tienen un impacto social e individual.
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/11.png', alt='')
      ...
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/12.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Tecnologías que generan nuevas formas de comunicación.
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus13
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/13.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Tecnología blanda – hace referencia a los elementos intangibles, cualquier tipo de software.
    .row.align-items-center.justify-content-center.mb-4
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/14.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Almacenamiento.
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/15.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Procesamiento.
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/16.png', alt='')
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/17.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Transformación socio-cultural en la forma de relacionamiento y comunicación.
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/18.png', alt='')
          p.ml-1-custom.mt-2.wd-80-cus Multimedio permitiendo la combinación de diferentes tipos de contenidos.
      .col-lg-4.my-3
        .bg11.d-flex.px-3.he-1-cus
          img.img-a.img-t.bg12.px-1.py-2(data-aos="zoom-in")(src='@/assets/curso/temas/19.png', alt='')
    ...
    .row.align-items-center.justify-content-center.mb-4
      ...
      .col-lg-7.my-3
        p(data-aos="fade-down") La disposición de los sistemas de información,<b>requieren establecer un plan que posibilite adoptar estrategias de servicios tecnológicos, y de esta forma se pueda garantizar la disponibilidad y la operación del servicio. </b>  Pues éste debe ser permanente y constante, para sus usuarios.
        .bg13.p-4.mb-1(data-aos="fade-left") Para el diseño del plan de gestión de servicios de TI, es importante tener en cuenta las actividades descritas en la G.ST.01 Guía del dominio de servicios tecnológicos, del Ministerio de Tecnologías de la Información y las Comunicaciones, del 2014, documento que permite la adopción de los elementos del dominio de los servicios tecnológicos, para Colombia, en el marco de la arquitectura de TI, razón por la cual se tomará de manera literal para su comprensión e implementación.
        .d-flex.align-items-center.justify-content-center
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/10.png', alt='')
    ...
    figure.mt-4.mb-5
      ...
      figcaption.ps-4 Figura 1. Actividades del plan de gestión de servicios TI
    .row
      .col-lg-2.mb-3
        img(src='@/assets/curso/temas/22.svg', alt='Actividades del plan de gestión de servicios TI')
    p(data-aos="fade-down").mb-5.color-green <b>La gestión de la capacidad, posibilita encargarse de las TI, </b> 
    ...
    p(data-aos="fade-down") En la siguiente figura se relacionan las actividades más significativas para la gestión de la capacidad:
    figure.mt-4.mb-5
      img(src='@/assets/curso/temas/25.svg', alt='Actividades del plan de gestión de servicios TI')
      figcaption.ps-4 Figura 2. Gestión de capacidad
    .row
      .col-lg-2.mb-3
        img(src='@/assets/curso/temas/26.svg', alt='Actividades del plan de gestión de servicios TI')
    p(data-aos="fade-down") Esta actividad se relaciona, con las acciones que se realizan al interior de la organización, y que permiten asegurar que todos los procesos críticos estarán disponibles para los clientes, proveedores y otras entidades que deban acceder a ellos, estas actividades se observan en el siguiente recurso educativo:
    .row
      .col-lg-12.mb-3
        ...
        .bloque-texto-a.color-acento-contenido.p-2.p-md-3.mb-5
          .row.m-0.align-items-center.justify-content-between
            .col-lg-2.mb-4.mb-lg-0
              img.w-75(src='@/assets/curso/temas/28.svg', alt='Actividades del plan de gestión de servicios TI')
            .col-lg-10
              .bloque-texto-a__texto.p-4
                p.mb-0 Estas actividades para la gestión de la calidad, se corresponden con algunos procesos de la organización, tal como se indican en la siguiente figura:
    figure.mt-4.mb-5
      ...
      figcaption.ps-4 Figura 3. Gestión de la continuidad - Nota. https://mintic.gov.co/arquitecturati/630/articles-9277_recurso_pdf.pdf    
    .row
      .col-lg-2.mb-3
        img(src='@/assets/curso/temas/30.svg', alt='Actividades del plan de gestión de servicios TI')
    ...
    p(data-aos="fade-down").mb-3 Las actividades claves para la Gestión de la Disponibilidad son las siguientes:
    .row
      .col-lg-12.mb-3
    ...
    figure.mt-4.mb-5
      ...
      figcaption.ps-4 Figura 4. Gestión de la continuidad - Nota. https://mintic.gov.co/arquitecturati/630/articles-9277_recurso_pdf.pdf    
